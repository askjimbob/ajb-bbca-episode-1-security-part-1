...
<body>
	...
	<cfoutput>
		<div id="wrapper" class="container-fluid">
			...
			<div class="row">
				<div class="col-md-12">
					<h1 class="page-header">Combined Example</h1>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-3">
					<a href="result.cfm?#hashedParams.url.userIdHash#=#encValues.url.userId#" class="btn btn-primary btn-block">View Profile</a>
				</div>
				<div class="col-md-3">
					<a href="result.cfm?#hashedParams.url.userIdHash#=#encValues.url.userId#" class="btn btn-primary btn-block">Edit Profile</a>
				</div>
				<div class="col-md-6">
					<a href="result.cfm?#hashedParams.url.userIdHash#=#encValues.url.userId#&amp;#hashedParams.url.formatHash#=#encValues.url.format#&amp;#hashedParams.url.startDateHash#=#encValues.url.startDate#&amp;#hashedParams.url.endDateHash#=#encValues.url.endDate#" class="btn btn-primary btn-block">Threads (last 30 days)</a>
				</div>
			</div>
			...
			<form action="result.cfm" method="POST">
				<div class="row">
					<div class="col-md-12">
						<input type="hidden" name="#hashedParams.form.userIdHash#" value="#encValues.form.userId#">
